    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = mul(UNITY_MATRIX_MVP, float4(v.vertex.xyz + v.normal*0.03*(_Outline*recipObjScale.r),1));
                return o;
            }
...
////// Emissive:
                ...
                float3 emissive = ((_Diffuse_var.rgb*UNITY_LIGHTMODEL_AMBIENT.rgb)+_Highlight.rgb);
...
/////// Vectors:
                ...
                float2 _Autotiletoscale_var = lerp( i.uv0, float2((node_7035.r*objScale.r),(node_7035.g*objScale.b)), _Autotiletoscale );
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(_Autotiletoscale_var, _Diffuse));
                o.Emission = ((_Diffuse_var.rgb*UNITY_LIGHTMODEL_AMBIENT.rgb)+_Highlight.rgb);
