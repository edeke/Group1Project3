...
Shader "Shader Forge/Examples/Boat_Shader" {
    Properties {
        ...
        _PurpleTiling ("Purple Tiling", Float ) = 0.97
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Emissive:
                ...
                float2 node_3887 = (i.uv0*0.97);
                float4 node_5771 = tex2D(_WoodMerge,TRANSFORM_TEX(node_3887, _WoodMerge));
                ...
                float3 _UseMasks_var = lerp( _Diffuse_copy_var.rgb, lerp(_Diffuse_copy_var.rgb,(((_BlackColor.rgb*node_4529)+(_CyanColor.rgb*node_2593)+(_YellowColor.rgb*node_4224)+((node_5771.r*_PurpleColor.rgb)*node_3112)+(lerp(((node_1922.r*node_1922.g)*_WhiteColor.rgb),_Wood_var.rgb,saturate((pow((_Wood_var.r+_WearThreshold),_WearExp)-_WearThreshold)))*node_7632))+(_RedColor.rgb*node_5900)+(((_HullWood_copy.r*_HullWood_copy.g)*_GreenColor.rgb)*node_1992)+(_BlueColor.rgb*node_9587)),((node_4529+node_2593+node_4224+node_3112+node_7632)+node_5900+node_1992+node_9587)), _UseMasks );
                float3 emissive = ((_UseMasks_var*UNITY_LIGHTMODEL_AMBIENT.rgb)+(_Highlight.rgb*(1.0-max(0,dot(normalDirection, viewDirection)))));
...
/////// Vectors:
                ...
                float node_9587 = (saturate((node_8685-(node_4199+node_9700)))*lerp( node_1404, node_2964, _UseBlue ));
                float3 _UseMasks_var = lerp( _Diffuse_copy_var.rgb, lerp(_Diffuse_copy_var.rgb,(((_BlackColor.rgb*node_4529)+(_CyanColor.rgb*node_2593)+(_YellowColor.rgb*node_4224)+((node_5771.r*_PurpleColor.rgb)*node_3112)+(lerp(((node_1922.r*node_1922.g)*_WhiteColor.rgb),_Wood_var.rgb,saturate((pow((_Wood_var.r+_WearThreshold),_WearExp)-_WearThreshold)))*node_7632))+(_RedColor.rgb*node_5900)+(((_HullWood_copy.r*_HullWood_copy.g)*_GreenColor.rgb)*node_1992)+(_BlueColor.rgb*node_9587)),((node_4529+node_2593+node_4224+node_3112+node_7632)+node_5900+node_1992+node_9587)), _UseMasks );
                o.Emission = ((_UseMasks_var*UNITY_LIGHTMODEL_AMBIENT.rgb)+(_Highlight.rgb*(1.0-max(0,dot(normalDirection, viewDirection)))));
