...
////// Emissive:
                ...
                float3 _UseMasks_var = lerp( _Diffuse_copy_var.rgb, lerp(_Diffuse_copy_var.rgb,(((_BlackColor.rgb*node_4529)+(_CyanColor.rgb*node_2593)+(_YellowColor.rgb*node_4224)+(_PurpleColor.rgb*node_3112)+(((node_1922.r*node_1922.g)*_WhiteColor.rgb)*node_7632))+(_RedColor.rgb*node_5900)+(((_HullWood_copy.r*_HullWood_copy.g)*_GreenColor.rgb)*node_1992)+(_BlueColor.rgb*node_9587)),((node_4529+node_2593+node_4224+node_3112+node_7632)+node_5900+node_1992+node_9587)), _UseMasks );
