...
////// Emissive:
                ...
                float3 _UseMasks_var = lerp( _Diffuse_copy_var.rgb, lerp(_Diffuse_copy_var.rgb,(((_BlackColor.rgb*(_UseBlack_var*node_7859))+(_CyanColor.rgb*(_UseCyan_var*node_9700))+(_YellowColor.rgb*(_UseYellow_var*node_4133))+(_PurpleColor.rgb*(_UsePurple_var*node_4199))+(_WhiteColor.rgb*(node_3469*_UseWhite_var)))+(_RedColor.rgb*(_UseRed_var*node_6555))+(_GreenColor.rgb*(_UseGreen_var*node_5793))+(_BlueColor.rgb*(node_2528*_UseBlue_var))),(((node_7859*_UseBlack_var)+(node_3469*_UseWhite_var)+(node_9700*_UseCyan_var)+(node_6555*_UseRed_var)+(node_4133*_UseYellow_var))+(node_5793*_UseGreen_var)+(node_4199*_UsePurple_var)+(node_2528*_UseBlue_var))), _UseMasks );
