...
Shader "Shader Forge/Examples/Painted_Box_Shader_2" {
    Properties {
        ...
        _ColorOpacity ("Color Opacity", Range(0, 1)) = 0.5213675
        _WearThreshold ("Wear Threshold", Range(-2, 2)) = 1
        _WearExponent ("Wear Exponent", Float ) = 2
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
...
////// Emissive:
                ...
                float3 node_9887 = lerp(node_8353,_PaintColor.rgb,_ColorOpacity);
                ...
                float node_9630 = (((node_5459.r*_Mask_var.g)+(node_9868.g*_Mask_var.r))+(node_4929.r*_Mask_var.b));
                float3 node_5347 = lerp(node_9887,node_8353,saturate((pow((node_9630+_WearThreshold),_WearExponent)-_WearThreshold)));
                float3 emissive = (node_5347*UNITY_LIGHTMODEL_AMBIENT.rgb);
                ...
                float3 finalColor = emissive + ((_LightColor0.rgb*node_2105)*node_5347);
...
////// Lighting:
                ...
                float node_9630 = (((node_5459.r*_Mask_var.g)+(node_9868.g*_Mask_var.r))+(node_4929.r*_Mask_var.b));
                float3 node_5347 = lerp(node_9887,node_8353,saturate((pow((node_9630+_WearThreshold),_WearExponent)-_WearThreshold)));
                float3 finalColor = ((_LightColor0.rgb*node_2105)*node_5347);
...
/////// Vectors:
                ...
                float node_9630 = (((node_5459.r*_Mask_var.g)+(node_9868.g*_Mask_var.r))+(node_4929.r*_Mask_var.b));
                float3 node_5347 = lerp(node_9887,node_8353,saturate((pow((node_9630+_WearThreshold),_WearExponent)-_WearThreshold)));
                o.Emission = (node_5347*UNITY_LIGHTMODEL_AMBIENT.rgb);
