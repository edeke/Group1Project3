...
////// Lighting:
                ...
                float3 finalColor = (_LightColor0.rgb*(lerp((_Diffuse_var.rgb*_WetColor.rgb),_Diffuse_var.rgb,saturate((saturate((i.posWorld.g-_WaterHeight))*_Wetlinesharpness)))*clamp(node_2105,UNITY_LIGHTMODEL_AMBIENT.rgb,1.0)));
