...
////// Emissive:
                ...
                float3 node_7231 = lerp((_Diffuse_var.rgb*_WetColor.rgb),lerp((node_507_if_leA*_Diffuse_var.rgb)+(node_507_if_leB*node_5122),node_5122,node_507_if_leA*node_507_if_leB),saturate((saturate((i.posWorld.g-_WaterHeight))*_Wetlinesharpness)));
