...
////// Lighting:
                ...
                float node_8377 = (saturate((i.posWorld.g-_WaterHeight))*_Wetlinesharpness);
                float3 node_7231 = lerp((_Diffuse_var.rgb*_WetColor.rgb),_Diffuse_var.rgb,saturate(node_8377));
                ...
                float3 finalColor = (_LightColor0.rgb*(node_7231*clamp(node_2105,UNITY_LIGHTMODEL_AMBIENT.rgb,1.0)));
