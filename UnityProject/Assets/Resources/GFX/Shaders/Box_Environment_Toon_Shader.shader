...
////// Lighting:
                ...
                float3 finalColor = (_LightColor0.rgb*(((_Diffuse_copy_copy.rgb*_Mask_var.r)+((_Diffuse_copy.rgb*_Mask_var.g)+(_Diffuse.rgb*_Mask_var.b)))*clamp(node_2105,UNITY_LIGHTMODEL_AMBIENT.rgb,1.0)));
