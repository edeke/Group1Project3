...
////// Emissive:
                ...
                float3 emissive = (node_8353*UNITY_LIGHTMODEL_AMBIENT.rgb);
                ...
                float3 finalColor = emissive + ((_LightColor0.rgb*node_2105)*node_8353);
...
////// Lighting:
                ...
                float4 _Diffuse = tex2D(_DiffuseTexture,TRANSFORM_TEX(node_1132, _DiffuseTexture));
                float3 node_8353 = ((_Diffuse_copy_copy.rgb*_Mask_var.r)+((_Diffuse_copy.rgb*_Mask_var.g)+(_Diffuse.rgb*_Mask_var.b)));
                float3 finalColor = ((_LightColor0.rgb*node_2105)*node_8353);
...
/////// Vectors:
                ...
                float4 _Diffuse = tex2D(_DiffuseTexture,TRANSFORM_TEX(node_1132, _DiffuseTexture));
                float3 node_8353 = ((_Diffuse_copy_copy.rgb*_Mask_var.r)+((_Diffuse_copy.rgb*_Mask_var.g)+(_Diffuse.rgb*_Mask_var.b)));
                o.Emission = (node_8353*UNITY_LIGHTMODEL_AMBIENT.rgb);
