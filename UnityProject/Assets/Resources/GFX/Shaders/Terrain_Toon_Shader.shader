...
////// Emissive:
                ...
                float node_566 = lerp(0.0,node_904,clamp(pow(node_982,_TansitionSharpness),0,1));
                float node_2475 = lerp(node_566,1.0,saturate(pow(saturate((node_982-1.0)),_TansitionSharpness)));
                ...
                float3 node_5965 = lerp(lerp(lerp(_BlackDiffuse_var.rgb,_RDiffuse_var.rgb,node_2475),_GDiffuse_var.rgb,i.vertexColor.g),_BDiffuse_var.rgb,i.vertexColor.b);
