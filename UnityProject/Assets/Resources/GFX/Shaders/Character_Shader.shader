...
////// Lighting:
                ...
                float3 finalColor = (_LightColor0.rgb*((_Diffuse_var.rgb*lerp(1.0,_AO_var.r,_AOIntensity))*clamp(node_2105,UNITY_LIGHTMODEL_AMBIENT.rgb,1.0)));
