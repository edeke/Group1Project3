...
/////// Vectors:
                ...
                float3 node_3339 = ((((_BlackColor.rgb*node_5698)*_UseBlack_var)+((_CyanColor.rgb*node_8134)*_UseCyan_var)+((_YellowColor.rgb*node_249)*_UseYellow_var)+((_PurpleColor.rgb*node_5930)*_UsePurple_var)+((_WhiteColor.rgb*node_2636)*_UseWhite_var))+((_RedColor.rgb*node_2438)*_UseRed_var)+((_GreenColor.rgb*node_5296)*_UseGreen_var)+((_BlueColor.rgb*node_9597)*_UseBlue_var));
                float4 _AO_var = tex2D(_AO,TRANSFORM_TEX(i.uv0, _AO));
                float3 node_2037 = (lerp( _Diffuse_var.rgb, lerp(_Diffuse_var.rgb,node_3339,(((node_5698*_UseBlack_var)+(node_2636*_UseWhite_var)+(node_8134*_UseCyan_var)+(node_2438*_UseRed_var)+(node_249*_UseYellow_var))+(node_5296*_UseGreen_var)+(node_5930*_UsePurple_var)+(node_9597*_UseBlue_var))), _UseMasks )*lerp(1.0,_AO_var.r,_AOIntensity));
