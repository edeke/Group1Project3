...
/////// Vectors:
                ...
                float3 node_280 = ((_BlackColor.rgb*node_5698)*_UseBlack_var);
                ...
                float3 node_7539 = ((_CyanColor.rgb*node_8134)*_UseCyan_var);
                ...
                float3 node_697 = ((_YellowColor.rgb*node_249)*_UseYellow_var);
                float node_5930 = (node_8820*node_8886); // Purple
                float _UsePurple_var = lerp( node_6817, node_2356, _UsePurple );
                float3 node_1768 = ((_PurpleColor.rgb*node_5930)*_UsePurple_var);
                ...
                return fixed4((node_2525*_OutlineColor.rgb),0);
            }
            ENDCG
        }
        Pass {
