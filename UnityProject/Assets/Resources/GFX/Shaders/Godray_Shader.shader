...
Shader "Shader Forge/Godray_Shader" {
    Properties {
        ...
        _Dusttiling ("Dust tiling", Float ) = 3
...
////// Lighting:
////// Emissive:
                float4 node_6518 = _Time + _TimeEditor;
                float2 node_2979 = ((i.uv0*(float2(0,1)+(float2(1,0)*_Tiling1)))+node_6518.g*float2(-0.03,0));
                float4 node_8028 = tex2D(_Texture,TRANSFORM_TEX(node_2979, _Texture));
                float2 node_1618 = ((i.uv0*(float2(0,1)+(float2(1,0)*_Tiling2)))+node_6518.g*float2(-0.014,0));
                ...
                float2 node_1972 = (i.uv1*_Dusttiling);
                float2 node_618 = (node_1972+node_6518.g*float2(0.01,0.02));
                float4 node_6706 = tex2D(_Texture,TRANSFORM_TEX(node_618, _Texture));
                float2 node_2509 = (node_1972+node_6518.g*float2(-0.02,-0.012));
                ...
                fixed4 finalRGBA = fixed4(finalColor,(((node_5679*_FresnelPostMult)*(saturate((node_2162+(saturate(((node_6706.b+_DustShift)*(node_7046.b+_DustShift)))*_Dustintensity)))*node_7511.g))*saturate((sceneZ-partZ)/_DepthFade)));
