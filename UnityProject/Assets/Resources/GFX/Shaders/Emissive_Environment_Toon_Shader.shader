...
////// Emissive:
                ...
                float3 emissive = ((_Diffuse_var.rgb*UNITY_LIGHTMODEL_AMBIENT.rgb)+(_EmissiveColor.rgb*_EmissiveIntensity*_EmissiveMap_var.r));
...
/////// Vectors:
                ...
                float4 _Diffuse_var = tex2D(_Diffuse,TRANSFORM_TEX(_Autotiletoscale_var, _Diffuse));
                float4 _EmissiveMap_var = tex2D(_EmissiveMap,TRANSFORM_TEX(i.uv0, _EmissiveMap));
                o.Emission = ((_Diffuse_var.rgb*UNITY_LIGHTMODEL_AMBIENT.rgb)+(_EmissiveColor.rgb*_EmissiveIntensity*_EmissiveMap_var.r));
