...
Shader "Shader Forge/Examples/Rat_Character_Shader" {
    Properties {
        ...
        [MaterialToggle] _HardSkinColor ("Hard Skin Color", Float ) = 0
        _HardSkinColor1 ("Hard Skin Color 1", Color) = (0.08012544,0.2867647,0.1670564,1)
        _HardSkinColor2 ("Hard Skin Color 2", Color) = (0.2763841,0.5294118,0.5084715,1)
...
/////// Vectors:
        ...
        Pass {
            ...
            uniform fixed _HardSkinColor;
            uniform float4 _HardSkinColor1;
            uniform float4 _HardSkinColor2;
...
////// Emissive:
                ...
                float node_3565 = (_UseYellow_var*node_249);
                float3 node_579 = ((_YellowColor.rgb*node_3565)+(_Diffuse_var.r*node_3565));
                ...
                float node_6696 = (node_9597*_UseBlue_var);
                float3 node_3055 = (_BlueColor.rgb*node_6696);
                ...
                float3 node_2037 = (lerp( _Diffuse_var.rgb, lerp(_Diffuse_var.rgb,((node_280+node_7539+node_579+node_1768+node_516)+node_7406+node_4425+lerp( (_Diffuse_var.rgb*node_3055), (lerp(_HardSkinColor1.rgb,_HardSkinColor2.rgb,_AO_var.g)*node_6696), _HardSkinColor )),node_3479), _UseMasks )*lerp(1.0,_AO_var.r,_AOIntensity));
