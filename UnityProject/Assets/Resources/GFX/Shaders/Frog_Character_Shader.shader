...
////// Emissive:
                ...
                float3 node_2037 = (lerp( _Diffuse_var.rgb, lerp(_Diffuse_var.rgb,((node_280+node_7539+node_697+node_1768+node_516)+node_7406+node_4425+lerp( (_Diffuse_var.rgb*node_3055), (lerp(_HardSkinColor1.rgb,_HardSkinColor2.rgb,_AO_var.g)*node_6696), _HardSkinColor )),node_3479), _UseMasks )*lerp(1.0,_AO_var.r,_AOIntensity));
